<template>
  <section class="section sec-36_60S">
    <div class="container main-container">
      <div class="main-title">
        <div class="text">
          <div class="title">Unit Type 36/60 Special</div>
        </div>
      </div>
      <div class="main-wrap">
        <div class="top">
            ...
            <div class="text">
              <div class="desc d-7">
                ...
                <div class="content">
                  ...
                  <span>:</span>
                  <div class="content-desc">
                    Pressed concrete blocks with plaster,<br />
                    Paint finishing
                  </div>
                </div>
                <div class="divider"></div>
                <div class="content">
                  ...
                  <span>:</span>
                  <div class="content-desc">
                    Ceramic KW-1 40x40cm for the<br />
                    main floor, toilet, and front terrace.
                  </div>
                </div>
                <div class="divider"></div>
                <div class="content">
                  ...
                  <span>:</span>
                  <div class="content-desc">
                    Hollow iron frame.<br />Gypsum cover with a paint finish.<br />Ceiling
                    height is 3.30 meters
                  </div>
                </div>
                <div class="divider"></div>
                <div class="content">
...
.sec-36_60S {
  ...
  .bottom {
    ...
    .main-text {
      ...
      .text {
        .desc {
          @include g.fontStyle(DINPro-Regular, 28px, 46px);
